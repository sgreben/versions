...
```sh
# Linux
curl -L https://github.com/sgreben/versions/releases/download/1.1.5/versions_1.1.5_linux_x86_64.tar.gz | tar xz

# OS X
curl -L https://github.com/sgreben/versions/releases/download/1.1.5/versions_1.1.5_osx_x86_64.tar.gz | tar xz

# Windows
curl -LO https://github.com/sgreben/versions/releases/download/1.1.5/versions_1.1.5_windows_x86_64.zip
unzip versions_1.1.5_windows_x86_64.zip
```
